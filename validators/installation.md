...
Before following the steps below, first set up a node.  Instructions are available [here](node/)[.](https://cascadia.gitbook.io/gitbook/validators/install-your-node)
