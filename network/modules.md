...
| Module              | Description                                                                                |
| ------------------- | ------------------------------------------------------------------------------------------ |
| abci                | Manages the ABCI protocol communication between the blockchain application and Tendermint. |
...
| baseapp             | A foundational structure upon which the Cosmos SDK application is built.                   |
...
| dbm                 | Offers a simple database interface for the Tendermint system.                              |
...
| ica                 | Manages operations for interchain accounts in IBC.                                         |
...
| log                 | Provides logging utilities for Tendermint operations.                                      |
...
| simapp              | Provides the simulation application for Cosmos SDK.                                        |
| simappparams        | Contains parameters used for simulations in Cosmos SDK.                                    |
...
| tmos                | Provides OS-level utility functions for Tendermint operations.                             |
| tmservice           | Provides GRPC-based service interfaces for Tendermint.                                     |
...
| version             | Manages the version of the Cosmos SDK.                                                     |
